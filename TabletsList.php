		...
		<div class="container" >
			<div class="row">
				<div class="col-sm-15 col-sm-15">
					...
					<br>
					<span style="color: white; margin-top: 50px; margin-left: 565px;">
						Tablets
					</span>
				</div>
			</div>
						...
						<form action="" method="GET">
							<div class="row">
									<div class="col-md-4">
										...
										<input type="text" name="start_price" value="<?php if(isset($_GET['start_price'])){echo $_GET['start_price']; }else{echo "300";} ?>" class="form-control">
									</div>
									<div class="col-md-4">
										<label for="">Max. Price</label>
										<input type="text" name="end_price" value="<?php if(isset($_GET['end_price'])){echo $_GET['end_price']; }else{echo "15000";} ?>" class="form-control">
									</div>
									<div class="col-md-4">
										<br/>
				...
				<div class="card-body">
					<div class="row">
						...
						if(isset($_GET['start_price']) && isset($_GET['end_price']))
						{
							...
							$query = "SELECT * FROM tablet WHERE price BETWEEN $startprice AND $endprice ";
						}
						else
						{
							$query = "SELECT * FROM tablet";
