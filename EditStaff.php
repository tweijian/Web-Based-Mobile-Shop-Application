<?php
    ...
    if(isset($_POST['update'])){   
        ...
        if(empty($Username) || empty($Password) || empty($Email)){          
            ...
            $result = mysqli_query($connect, "UPDATE staff SET username='$Username',password='$Password',email='$Email' WHERE id=$ID");
...
<?php
    $ID = $_GET['id'];
    $result = mysqli_query($connect, "SELECT * FROM staff WHERE id=$ID");
...
<html>
            ...
            <div class="row">
                <div class="col-sm-15 col-sm-15">
                    <h1 style="color: white; margin-top: 50px; margin-left: 300px;">
                       Staff Panel - Edit Staff Account
					</h1>
                </div>
            </div>
        </div>
    ...
    <div style="margin: 10px;">
		<div class="card">
            <div class="card-body">
                <a class="btn btn-info" href="ManageStaff.php">Back</a>
                <br/><br/>
