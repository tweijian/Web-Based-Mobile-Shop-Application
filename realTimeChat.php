<?php
    ...
    $toUser = $_POST["toUser"];
    $output = "";
    $chats = mysqli_query($connect, "SELECT * FROM messages where (FromUser = '".$fromUser."' AND ToUser = '".$toUser."') OR 
    ...
    while($chat = mysqli_fetch_assoc($chats)){
        if($chat["FromUser"]== $fromUser)
            ...
            $output.= "<div style='text-align:left;'>
                    <p style='background-colour:yellow; word-wrap:break-word; display:inline-block;
