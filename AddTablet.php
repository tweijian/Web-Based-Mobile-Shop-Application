<?php
	...
	if(!empty($_POST)){
		...
		if(move_uploaded_file($tmp_name,$location.$model.".jpg")){
			...
			$DB = new Database();
			$tablet = new Tablet(0, $model, $brand, $price, $releaseDate, $discountRate, $imageUrl,
...
<html>
            ...
            <div class="row">
                <div class="col-sm-15 col-sm-15">
                    <h1 style="color: white; margin-top: 50px; margin-left: 250px;">
                       Admin Panel - Add Tablet Phone Products
					</h1>
                </div>
            </div>
        </div>
	...
	<form class="form-horizontal" action="AddTablet.php" method="post" enctype="multipart/form-data">
		<a class="btn btn-info" href="ManageTablet.php" style="margin-left: 25px;">Back</a>
		<fieldset style="margin: 20px;">
			<legend><center>Add Tablet Phone</center></legend>
			<div class='card'>
				<div class='card-body'>
